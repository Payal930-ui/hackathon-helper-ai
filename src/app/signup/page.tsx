...
import { Moon, Sun, Mail, Eye, EyeOff, Loader2, CheckCircle2, XCircle } from "lucide-react";
      ...
      >
        <div className="text-center">
          ...
          <p className="mt-2 text-sm text-gray-600 dark:text-gray-400">
            Join the elite hackathon community
          </p>
        </div>
        ...
        <div className="space-y-4">
          <Button 
            variant="outline" 
            className="w-full py-6 dark:border-gray-700 dark:hover:bg-gray-800"
        ...
        <form className="space-y-4" onSubmit={handleSubmit(handleSignup)}>
          <div className="space-y-2">
            ...
            <Input 
              ...
              className={errors.name ? "border-red-500" : "dark:bg-gray-800"}
            />
          ...
          <div className="space-y-2">
            ...
            <Input 
              ...
              className={errors.email ? "border-red-500" : "dark:bg-gray-800"}
            />
          ...
          <div className="space-y-2">
            ...
            <div className="relative">
              <Input 
                ...
                placeholder="••••••••" 
                className={errors.password ? "border-red-500" : "dark:bg-gray-800"}
              />
              <button 
                type="button"
          ...
          <div className="space-y-2">
            ...
            <Input 
              ...
              type="password" 
              placeholder="••••••••" 
              className={errors.confirmPassword ? "border-red-500" : "dark:bg-gray-800"}
            />
          ...
          <p className="text-center text-sm text-gray-600 dark:text-gray-400">
            ...
            <Link href="/login" className="font-bold text-blue-600 hover:text-blue-500 underline underline-offset-4">
              Log in
            </Link>
          </p>
        </form>
