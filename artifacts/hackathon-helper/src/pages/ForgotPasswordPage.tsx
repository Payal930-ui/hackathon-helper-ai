...
export default function ForgotPasswordPage() {
  ...
  const handleReset = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (code === "auth/user-not-found") message = "No account found with this email address.";
    ...
    <div className="flex min-h-screen items-center justify-center bg-gray-50 dark:bg-gray-950 px-4">
      ...
      >
        <div className="text-center">
          <h2 className="text-3xl font-extrabold tracking-tight text-gray-900 dark:text-white">Reset Password</h2>
          <p className="mt-2 text-sm text-gray-600 dark:text-gray-400">We'll send you a link to get back into your account</p>
        </div>
        ...
        {sent ? (
          <div className="space-y-6 text-center">
            ...
            <Link href="/login">
              <Button variant="outline" className="w-full rounded-xl py-6 mt-4">Back to Login</Button>
            </Link>
          </div>
        ) : (
          <form className="space-y-6" onSubmit={handleReset}>
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <Input type="email" required placeholder="john@example.com" className="pl-10 dark:bg-gray-800" value={email} onChange={(e) => setEmail(e.target.value)} />
              </div>
            </div>
