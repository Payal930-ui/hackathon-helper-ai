      ...
      >
        ...
        <form className="space-y-4" onSubmit={handleSubmit(handleLogin)}>
          <div className="space-y-2">
            ...
            <div className="relative">
              ...
              <Input 
                ...
                className={`pl-10 ${errors.email ? "border-red-500" : "dark:bg-gray-800"}`}
              />
            </div>
          ...
          <div className="space-y-2">
            <div className="flex items-center justify-between">
              ...
              <Link
                ...
                className="text-xs font-bold text-blue-600 hover:text-blue-500 underline underline-offset-4"
              >
                Forgot password?
              </Link>
            </div>
            <div className="relative">
              ...
              <Input 
                ...
                placeholder="••••••••" 
                className={`pl-10 ${errors.password ? "border-red-500" : "dark:bg-gray-800"}`}
              />
              <button 
                type="button"
          ...
          <p className="text-center text-sm text-gray-600 dark:text-gray-400">
            ...
            <Link href="/signup" className="font-bold text-blue-600 hover:text-blue-500 underline underline-offset-4">
              Sign up
            </Link>
          </p>
        </form>
