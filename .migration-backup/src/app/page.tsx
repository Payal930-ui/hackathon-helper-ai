...
import { Rocket, Target, Layout, Code, FileText, CheckCircle, Zap, Shield, Star, Users, ArrowRight, Bot, Sparkles, Presentation } from "lucide-react";
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="flex justify-between items-center h-20">
            ...
            <div className="hidden md:flex items-center space-x-8">
              ...
              <Link href="#how-it-works" className="text-sm font-bold text-gray-500 hover:text-blue-600 transition-colors">Workflow</Link>
              <Link href="#testimonials" className="text-sm font-bold text-gray-500 hover:text-blue-600 transition-colors">Success Stories</Link>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <FeatureCard 
              ...
              title="AI Project Scores" 
              description="Get instant feedback on innovation, feasibility, and winning probability before you start."
            />
            <FeatureCard 
              icon={<Bot className="text-purple-600" />} 
              title="24/7 AI Mentor" 
              description="Project-specific chat assistant that knows your tech stack and helps you debug in real-time."
            />
            <FeatureCard 
              icon={<Layout className="text-pink-600" />} 
              title="Smart UI/UX" 
              description="Complete design systems with color palettes, typography, and responsive wireframes."
            />
            <FeatureCard 
              icon={<FileText className="text-orange-600" />} 
              title="Pitch Generator" 
              description="Craft the perfect 30s, 1m, or 3m pitch to impress judges and investors."
            />
            <FeatureCard 
              icon={<Users className="text-green-600" />} 
              title="Task Distributor" 
              description="Automatically assign tasks based on your team size and member skillsets."
            />
            <FeatureCard 
              icon={<Presentation className="text-red-600" />} 
              title="PPT Architect" 
              description="Generate a professional 10-slide deck ready for your final presentation."
            />
          </div>
        </div>
      </section>
      ...
      <footer className="py-20 border-t border-gray-100 dark:border-gray-900 bg-white dark:bg-gray-950">
        <div className="max-w-7xl mx-auto px-6 text-center">
          ...
          <div className="flex justify-center gap-8">
            <Link href="#" className="text-gray-400 hover:text-blue-600 transition-colors text-xs font-bold uppercase tracking-widest">Twitter</Link>
            <Link href="#" className="text-gray-400 hover:text-blue-600 transition-colors text-xs font-bold uppercase tracking-widest">Github</Link>
            <Link href="#" className="text-gray-400 hover:text-blue-600 transition-colors text-xs font-bold uppercase tracking-widest">Discord</Link>
          </div>
        </div>
      </footer>
    </div>
